...
/*
  ...
  Upload this same sketch to two Arduino Unos with XBees.
  ...
  Behavior:
  - sends <PING,myId,seq> about once per second
  - prints every received PING
  - replies with <PONG,peerId,seq,myId>
  - prints every received PONG addressed to this Uno
*/

const uint8_t XBEE_RX = 2;
const uint8_t XBEE_TX = 3;
